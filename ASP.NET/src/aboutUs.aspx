<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="aboutUs.aspx.cs" Inherits="KritzArtGallery.about_us" %>
  ...
  <table width="726" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td height="184" valign="top" background="images/middle-bg.jpg">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="35" colspan="2" align="center" valign="top" class="top_head">Welcome to Kritz Art Gallery</td>
          </tr>
          <tr>
            <td width="355" valign="top" style="padding-left: 20px;">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="130" height="129">
                          <table border="1" cellpadding="0" cellspacing="0" bordercolor="#B0B9BB" style="border-collapse: collapse;">
                            <tr>
                              <td width="130" height="129" align="center" valign="middle">
                                <img src="images/about-us-main.jpg" alt="" width="125" height="124" /></td>
                            </tr>
                          </table>
                        </td>
                        <td class="contain_sub" style="padding-left: 10px;">
                          ...
                          <br />
                          We have figurative, landscape, as well as abstract in all form of style of Art.</td>
                </tr>
              </table>
            </td>
          </tr>
      ...
      <td width="371" align="left" valign="top" style="padding-left: 30px; padding-right: 20px;"
        class="contain_sub">The paintings are Vivid, Vibrant, Energetic, along with an element of Indian culture.<br />
        <br />
        We have a Vast and Exquisite Range of Artefact&rsquo;s and hand crafted Masterpieces
                            of Art.<br />
        <br />
        We have recently introduced Potrait Painting from Photographs of minimum size of
                            4 X 6 inches. We invite you to visit our gallery and witness some great works of
                            Art and Artefacts.</td>
      </tr>
        </table>
      </td>
    </tr>
