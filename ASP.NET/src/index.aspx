<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index1.aspx.cs" Inherits="KritzArtGallery.index1" %>
        ...
        <td>
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td style="height: 40px">
                <asp:ImageButton ID="btnArtGallery" runat="server" ImageUrl="images/art-gallery.jpg"
                  OnClick="btnArtGallery_Click" /></td>
              <td style="height: 40px">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="100%" valign="bottom" background="images/nav-bot-bg.jpg">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="top_head" style="padding-left: 125px;">
                      <strong>Our Best Collection</strong></td>
                  </tr>
                </table>
              </td>
            ...
            <tr>
              <td width="239" valign="top" style="padding-left: 31px;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td class="contain_sub" style="padding-top: 5px; padding-right: 30px;">
                      <strong>Kritz Art Gallery</strong> situated in the heart of the Art World display’s Arts of various leading Artists like Thomsen Lisa, Thirtle Joell, Betho Ariana, Habbeshaw Rees, Sine Bailie, Kerslake Portie, Damper Ezechiel, Contemporary as well as some great Masterpieces.
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td height="25" class="readmore">
                            <a href="aboutUs.aspx" class="readmore"><strong>READ MORE </strong></a>
                          </td>
                        </tr>
                      </table>
                    </td>
                              ...
                              <tr>
                                ...
                                <td valign="top" class="border_curve">
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td width="3%">
                                        <a href="#null" onmouseover="scrollDivRight('container')" onmouseout="stopMe()">
                                          ...
                                          <div id="scroller">
                                            <div class="content">
                                              <a href="images/big-images/abstract.jpg" rel="lightbox[lamb]" title="">
                                                <img src="images/abstract.jpg" width="96" height="105" border="0" /></a><div class="main_contain">
                                                  Abstract
                                                </div>
                                            </div>
                                            <div class="content">
                                              <a href="images/big-images/figurative.jpg" rel="lightbox[lamb]" title="">
                                                <img src="images/figurative.jpg" width="96" height="105" border="0" /></a><div class="main_contain">
                                                  Figurative
                                                </div>
                                            </div>
                                            <div class="content">
                                              <a href="images/big-images/landscape.jpg" rel="lightbox[lamb]" title="">
                                                <img src="images/landscape.jpg" width="96" height="105" border="0" /></a><div class="main_contain">
                                                  Landscape
                                                </div>
                                            </div>
                                            <div class="content">
                                              <a href="images/big-images/artifacts.jpg" rel="lightbox[lamb]" title="">
                                                <img src="images/artifacts.jpg" width="96" height="105" border="0" /></a><div class="main_contain">
                                                  Artifacts
                                                </div>
                                            </div>
                                            <div class="content">
                                              <a href="images/big-images/abstract2.jpg" rel="lightbox[lamb]" title="">
                                                <img src="images/abstract2.jpg" width="96" height="105" border="0" /></a><div class="main_contain">
                                                  Abstract
                                                </div>
                                            </div>
                                            <div class="content">
                                              <a href="images/big-images/figurative2.jpg" rel="lightbox[lamb]" title="">
                                                <img src="images/figurative2.jpg" width="96" height="105" border="0" /></a><div class="main_contain">
                                                  Figurative
                                                </div>
                                            </div>
                                            <div class="content">
                                              <a href="images/big-images/landscape2.jpg" rel="lightbox[lamb]" title="">
                                                <img src="images/landscape2.jpg" width="96" height="105" border="0" /></a><div class="main_contain">
                                                  Landscape
                                                </div>
                                            </div>
                                            <div class="content">
                                              <a href="images/big-images/artifacts2.jpg" rel="lightbox[lamb]" title="">
                                                <img src="images/artifacts2.jpg" width="96" height="105" border="0" /></a><div class="main_contain">
                                                  Artifacts
                                                </div>
                                            </div>
                                          </div>
                                      ...
                                      <td width="4%" align="right">
                                        <a href="#null" onmouseover="scrollDivLeft('container')" onmouseout="stopMe()">
